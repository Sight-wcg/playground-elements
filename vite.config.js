  ...
  plugins: [
    {
      ...
      resolveId(id) {
        if (id.endsWith('/playground-typescript-worker.js')) return virtualTSWS;
    ...
    },
    {
      ...
      enforce: 'pre',
      resolveId(id) {
        if (id === 'virtual:pg-sandbox') return virtualSandbox;

        return undefined;
      },
      load(id) {
        if (id === virtualSandbox) return `export default '${sandboxDir}'`;
